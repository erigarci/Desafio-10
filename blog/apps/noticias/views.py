...
#se importa reverse_lazy para los comentarios
...
#uso de decorador para verificar logeo de usuario
@login_required
def inicio(request):
    #ctx={}
    ...
    if id_categoria:
        ...
        n = Noticia.objects.all()  #esto genera una lista de las noticias
